...
//fxb for io test
#define FXB_GPIO5_IO31_OFF 		volatile unsigned int * a = (volatile unsigned int *)0x20c407c;\
		volatile unsigned int * b = (volatile unsigned int *)(0x020E0000 + 0x288);\
		volatile unsigned int * c = (volatile unsigned int *)(0x020E0000 + 0x28C);\
		volatile unsigned int * d = (volatile unsigned int *)0x20e0930;\
		volatile unsigned int * e = (volatile unsigned int *)(0x020E0000 + 0x658);\
		volatile unsigned int * f = (volatile unsigned int *)(0x020E0000 + 0x65c);\
		*a = 0XFFFFFFFF;\
		*b = 0x2;\
		*c= 0x2;\
		*d= 0x1;\
